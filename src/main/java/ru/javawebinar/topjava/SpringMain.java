...
public class SpringMain {
    public static void main(String[] args) {
        ...
        try (ConfigurableApplicationContext appCtx = new ClassPathXmlApplicationContext("spring/spring-app.xml")) {
            ...
            User userThree = adminUserController.create(new User(null, "userName", "emailThree@mail.ru", "password", Role.ADMIN));
            User userFour = adminUserController.create(new User(null, "userName", "emailFour@mail.ru", "password", Role.ADMIN));
            ...
            System.out.println("test get, update, delete methods");
            System.out.println("=========================================================");
            Meal mealOne = mealRestController.get(1, userOne.getId());
            ...
            try {
                mealOne.setId(2);
                mealRestController.update(mealOne, 2, userTwo.getId());
            } catch (NotFoundException ex) {
                System.out.println("Can't update others meal");
            }

            try {
                mealRestController.delete(2, userTwo.getId());
            } catch (NotFoundException ex) {
