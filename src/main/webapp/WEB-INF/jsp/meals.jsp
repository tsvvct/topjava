...
<script src="resources/js/topjava.meal.js" defer></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <div id="modal-title-add">
                <h4><spring:message code="meal.add"/></h4>
                </div>
                <div id="modal-title-edit">
                <h4><spring:message code="meal.edit"/></h4>
                </div>
