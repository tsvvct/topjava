                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item"
                           href="${pageContext.request.request.getAttribute('javax.servlet.forward.request_uri')}?locale=en">English</a>
                        <a class="dropdown-item"
                           href="${pageContext.request.request.getAttribute('javax.servlet.forward.request_uri')}?locale=ru">Русский</a>
                    </div>
                </li>
            </ul>
        </div>
